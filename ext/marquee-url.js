...
function initNavIcons(allArticlesData, currentFilename) {
  ...
  iconContainer.innerHTML = `
      ...
      <a href="https://frijal.github.io/feed.html" title="Update harian berisi 30 judul artikel terbaru."><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"><defs><linearGradient id="g1" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#FF6F00"/><stop offset="100%" stop-color="#FFA726"/></linearGradient></defs><rect width="48" height="48" rx="12" fill="url(#g1)"/><circle cx="14" cy="34" r="4" fill="#fff"/><path d="M12 22a16 16 0 0 1 14 14" stroke="#fff" stroke-width="3" fill="none" stroke-linecap="round"/><path d="M12 14a24 24 0 0 1 22 22" stroke="#fff" stroke-width="3" fill="none" stroke-linecap="round"/></svg>
      </a>
      <a href="https://frijal.github.io" title="Home"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"><defs><linearGradient id="g2" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#388E3C"/><stop offset="100%" stop-color="#66BB6A"/></linearGradient></defs><rect width="48" height="48" rx="12" fill="url(#g2)"/><path d="M24 14L12 24h4v10h8v-6h4v6h8V24h4L24 14z" fill="#fff"/></svg>
      </a>
