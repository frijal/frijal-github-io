...
// Core folders
if (folders.includes('node_modules')) addBlock('DEPENDENCIES & BUILD', ['node_modules/']);
...
// System artifacts
addBlock('SYSTEM & IDE ARTIFACTS', ['.DS_Store', 'Thumbs.db', '.vscode/', '.idea/']);
...
addBlock('INTERACTIVE HTML PAGES', ['*.bak.html', '*.draft.html', '*.preview.html', '*.snapshot.html']);
